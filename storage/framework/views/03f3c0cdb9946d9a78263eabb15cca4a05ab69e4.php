                ...
                <?php $__currentLoopData = $quests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(count($quests) == 1): ?>
                        ...
                        <span class='gallery-hover-3col hidden-phone hidden-tablet'>
                            <img src=<?php echo e($q->avatar); ?> class="thum" alt="image">
                            <span class='gallery-icons'>
                                <a href='#' class='item-zoom-link lightbox' title='Просмотр' onclick='showDetails(this)'
                                   data-rel="<?php echo $q->name; ?>"></a>
                                <a href='<?php echo e(route('more', ['id'=>$q->id])); ?>' class='item-details-link '
                                   title='Играть'></a>
                            </span>
                        </span>
                                <span class='project-details'><a
                                            href='<?php echo e(route('more', ['id'=>$q->id])); ?>'><?php echo $q->name; ?></a><?php echo $q->description; ?>

                                    <br><?php echo $q->date; ?></span>
                            </li>
                        </div>
                    <?php elseif(count($quests) < 3): ?>
                        ...
                        <span class='gallery-hover-3col hidden-phone hidden-tablet'>
                            ...
                            <span class='gallery-icons'>
                                ...
                                <span class='project-details'><a href='<?php echo e(route('more', ['id'=>$q->id])); ?>'
                                                                 class="name"><?php echo $q->name; ?></a><?php echo $q->description; ?>
