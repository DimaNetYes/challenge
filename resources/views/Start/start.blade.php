        ...
        <footer>
            <div class="footer">
                <div class="rows">
                    ...
                    <div class="desc">QR-код получил широкое распространение за счет того, что информацию, в нем
                        содержащуюся, легко можно прочесть с помощью камеры мобильника.
                        Для этого достаточно иметь на своем телефоне одну из программ-распознавалок QR-кодов, коих
